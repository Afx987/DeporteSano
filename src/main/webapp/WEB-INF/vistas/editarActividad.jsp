...
<section>
    ...
    <table class="table">
        ...
        <form:form action="modificarActividad" modelAttribute="actividad" method="POST">
            <form:hidden path="idActividad" />
                <div class="col-md-4 mb-3">
                    <td><form:input type="text" class="form-control" path="nombre"/>
                      </td>

                </div>
                <div class="col-md-4 mb-3">

                    <td><form:input type="date" class="form-control" path="fecha"/>
                        </td>
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <td><form:input type="text" class="form-control" path="horario"/>
                        </td>

                </div>
                <div class="col-md-4 mb-3">

                    <td><form:input type="text" class="form-control" path="profesor"/>
                        </td>
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <td><form:input type="text" class="form-control" path="ubicacion"/>
                        </td>
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <td><form:input type="text" class="form-control" path="categoria"/>
                        </td>
